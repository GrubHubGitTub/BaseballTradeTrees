...
# trans.to_csv("transac2021pre-delete.csv", index=False)

"""sort trans by name and date and then check for F/Fg or R/Fg """
...
# deleted.to_csv("transac2021cleaned.csv", index=False)
